...
public class VirtualPlayerManager_1152 implements VirtualPlayerManager {
    ...
    public static VirtualPlayerManager SpawnPlayer(OfflinePlayer op, Location originalLoc) { // Returns VirtualPlayerManager interface so plugin can be used on multiple versions of Minecraft
        VirtualPlayerManager_1152 vpm = new VirtualPlayerManager_1152(); // Create Virtual Player Manager
    ...
    private VirtualPlayerManager_1152() {} // VPM creation only allowed through SpawnPlayer(...)
}
